...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_AXIS_BYTEWIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_AXIS_BYTEWIDTH { PARAM_VALUE.C_AXIS_BYTEWIDTH } {
	# Procedure called to update C_AXIS_BYTEWIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXIS_BYTEWIDTH { PARAM_VALUE.C_AXIS_BYTEWIDTH } {
	# Procedure called to validate C_AXIS_BYTEWIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_AXIS_BYTEWIDTH { MODELPARAM_VALUE.C_AXIS_BYTEWIDTH PARAM_VALUE.C_AXIS_BYTEWIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXIS_BYTEWIDTH}] ${MODELPARAM_VALUE.C_AXIS_BYTEWIDTH}
}
